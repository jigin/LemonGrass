...
public class Salads_Fragment extends Fragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("soups");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.salads_recycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.salads_catid);
