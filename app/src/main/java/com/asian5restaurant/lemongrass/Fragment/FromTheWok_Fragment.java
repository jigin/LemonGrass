...
public class FromTheWok_Fragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_from_wok, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("sandwiches");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.wokRecycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.wokCatid);
