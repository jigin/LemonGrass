...
public class RiceNNoodles_Fragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_riceandnoodels, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("rice & noodles");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.riceRecycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.ricecatId);
