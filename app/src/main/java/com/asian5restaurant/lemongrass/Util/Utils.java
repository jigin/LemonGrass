...
public class Utils
{
    ...
    public static final String LOGIN_URL = "http://www.asian5restaurant.com/androidapi/userlogin.php";
    public static final String ALL_FOOD_URL = "http://www.asian5restaurant.com/androidapi/getmenuall.php";
    public static final String SET_REVIEW_URL = "http://www.asian5restaurant.com/androidapi/setreview.php";
    public static final String SET_SUBSCRIBE_URL = "http://www.asian5restaurant.com/androidapi/setsubscribe.php";
