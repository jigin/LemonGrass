...
public class WaterNSodas extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_water_sodas, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("8");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.waterRecycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.waterCatid);
