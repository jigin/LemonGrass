...
public class Deserts_Fragment extends Fragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("6");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.desertsRecycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.desertsCatid);
    ...
    /*public class GetDeserts extends AsyncTask<String,String,String>
    {
        @Override
