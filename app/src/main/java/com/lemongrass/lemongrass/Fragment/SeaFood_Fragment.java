...
public class SeaFood_Fragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_seafood_special, container, false);
    }

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        Log.e("fragSeafood","onAttach");
    }

    @Override
    public void onAttach(Activity activity) {
        super.onAttach(activity);
        Log.e("fragSeafood","onAttach Activity");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.e("fragSeafood","onDestroy");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        Log.e("fragSeafood","onDetach");
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("4");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.seafoodspecialrecycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.seafood_catid);
    ...
    /*public class GetAllSeaFood extends AsyncTask<String,String,String>
    {
        @Override
