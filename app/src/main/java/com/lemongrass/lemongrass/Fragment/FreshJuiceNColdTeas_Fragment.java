...
public class FreshJuiceNColdTeas_Fragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_freshjuice, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("10");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.freshjuiceRecycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.freshjuiceCatid);
    ...
    /*public class GetFreshJuice extends AsyncTask<String,String,String>
    {
        @Override
