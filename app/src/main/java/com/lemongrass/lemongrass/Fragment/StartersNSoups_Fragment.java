...
public class StartersNSoups_Fragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_starters_soups, container, false);
    }

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        Log.e("fragStarters","onAttach");
    }

    @Override
    public void onAttach(Activity activity) {
        super.onAttach(activity);
        Log.e("fragStarters","onAttach Activity");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.e("fragStarters","onDestroy");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        Log.e("fragStarters","onDetach");
    }
    ...
    public void onLowMemory() {
        super.onLowMemory();
        Log.e("fragStarters","onLowMemory");
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list = db.getItemByCat("1");

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.startersrecycler);
        ...
        catId = (TextView) getActivity().findViewById(R.id.starters_catid);
    ...
    /*public class GetStarters extends AsyncTask<String,String,String>
    {
        @Override
