...
public class Tab_Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new All_Fragment(), "Appetizers");
        adapter.addFragment(new All_Fragment(), "Soups");
        adapter.addFragment(new All_Fragment(), "Rice & Noodles");
        adapter.addFragment(new All_Fragment(), "Sandwichs");
