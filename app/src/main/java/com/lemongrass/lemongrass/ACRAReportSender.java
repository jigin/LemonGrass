...
public class ACRAReportSender implements ReportSender {
    ...
    public void send(Context context, CrashReportData report)
        ...
        shared = context.getSharedPreferences("login_details", Context.MODE_PRIVATE);
		 /* sdh=new SqliteDatabaseHandler(context);*/
        username = shared.getString("name", null);
        ...
        Log.e("Sending email", reportBody);

        try {
            // specify your recipients and send the email
            gMailSender.sendMail("CRASH REPORT", reportBody, emailUsername, "android@webqua.com,crashwebqua@gmail.com");
        } catch (Exception e) {
