...
import com.lemongrass.lemongrass.Activity.Subscribe_Activity;
            ...
            if (Utils.hasInternetConnection(getApplicationContext())) {
                ...
                for(int i =0; i<size;i ++) {
                    ...
                    if (Utils.isNetworkAvailable(context)) {
                        //String SubscribeUrl = "http://www.lemongrassrestaurants.com/androidapi/setsubscribe.php?name=" + list.get(i).getName() + "&email=" + list.get(i).getEmail();
